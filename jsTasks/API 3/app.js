...
async function getData() {
    ...
    try {
        ...
        root.innerHTML += `<h1>Mypromise Name:${data.name}; Mypromise job: ${data.job}</h1>`
        root.innerHTML += `<h1>Mypromise Age:${data.age}; Mypromise location: ${data.location}</h1>`
    } catch (error) {
        console.log(error)
    }
}